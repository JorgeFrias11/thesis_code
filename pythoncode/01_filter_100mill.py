...
data, coin_id = ipca_utils.load_coindata('daily', datapath,
                                ...
                                daily_rds='daily_predictors_100mill.rds',
...
filtered_data.to_pickle("/home/jfriasna/thesis_data/data/filtered_daily_panel_100mill.pkl")
...
data.to_pickle("/home/jfriasna/thesis_data/data/processed_daily_preds_100mill.pkl")
